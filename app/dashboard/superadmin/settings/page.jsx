...
//         <h1 className="h4">System Settings</h1>
...
//             <input type="text" className="form-control" defaultValue="SchoolERP" />
//           </div>
//           <div className="col-md-6">
//             <label className="form-label">Support Email</label>
//             <input type="email" className="form-control" defaultValue="support@schoolerp.com" />
//           </div>
//           <div className="col-12">
//             <label className="form-label">About</label>
//             <textarea className="form-control" rows="3" defaultValue="Central ERP for Schools"></textarea>
//           </div>
//           <div className="col-12">
